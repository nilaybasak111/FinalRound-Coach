...
function AIResponsePreview({ content }: any) {
      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            table({ children }) {
              return (
                <div className="overflow-x-auto my-4">
                  <table className="min-w-full divided-y divide-gray-300 border border-gray-200">
                    {children}
                  </table>
                </div>
              );
            ...
            th({ children }) {
              return (
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase trcaking-wider">
                  {children}
                </th>
              );
            },
